...
public class KnownHosts
{
	...
	private final LinkedList<KnownHostsEntry> publicKeys = new LinkedList<KnownHostsEntry>();
	...
	private void initialize(File knownHosts) throws IOException {
		...
		Reader reader = new FileReader(knownHosts);
		try{
			while (true) {
	...
	private String[] recommendHostkeyAlgorithms(String hostname)
	{
		...
		List<String> supportedAlgorithms = new ArrayList<String>();
