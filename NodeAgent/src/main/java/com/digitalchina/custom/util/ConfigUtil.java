...
public class ConfigUtil {
	...
	public static Properties loadFromPaasConfigCenter() {
		...
		String host, user, password, appName, type, port;
		...
		if (debug) {
			...
			port = System.getProperty("ConfigPort");
			type = "password";
		} else {
			...
			port = System.getenv("ConfigPort");
			// 写在环境变量的是md5加密的password
			type = "md5";
		}
		Map<String, Object> map = new HashMap<String, Object>();
		ConfigClient configClient = new ConfigClient(host, port, user,
				password, appName);
