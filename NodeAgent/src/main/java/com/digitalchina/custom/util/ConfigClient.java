...
public class ConfigClient {
	 ...
	 * @author hannn
	 * @param ip
	 *            the ip of configcenter
	 * @param port
	 *            port of configcenter default 5091
	 * @param userName
	 *            paas用户名
	 * @param password
	 *            paas密码
	 ...
	 *            应用版本 初始化配置中心客户端基本参数
	 * */
	public ConfigClient(String host, String port, String userName,
			String password, String moduleName) {
		this.host = host;
	...
	/**
	 * 获取配置中心密码类型 （md5默认 , password） md5 表示当前密码为md5之后的结果， password 表示当前密码为明文密码
	 */
	...
	private boolean check() {
		...
		if (password == null || "".equals(password)) {
			System.out.println("please set the userName of configcenter user:"
					+ userName);
			return false;
		}
		if (module == null || "".equals(module)) {
			System.out
					.println("please set the moduleName of the config you want");
			return false;
		}
	...
	private boolean sendRequest(String url, String params) {
		...
		Map<String, String> map = JSON.parseObject(temp,
