...
public class HttpRequestUtils {
     ...
     * @return
     */
    public static String httpPost(String url,Map<String, Object> textMap,FormDataBodyPart fileBody){
    	String res = "";  
        ...
        try {  
            ...
            // file    
            if (fileBody != null) { 
                InputStream inputValue =   fileBody.getValueAs(InputStream.class);  
                String filename =fileBody.getFormDataContentDisposition().getFileName();  
                
                MediaType fileMedia = fileBody.getMediaType();
                String contentType = fileMedia.getType()+"/"+fileMedia.getSubtype(); 
                StringBuffer strBuf = new StringBuffer();  
